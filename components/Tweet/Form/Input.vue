<template>
  <div>
    <div class="flex items-center flex-shirt-0 p-4 pb-0">
      ...
      <div class="w-full p-2">
        <textarea
          ...
          class="overflow-hidden w-full h-10 text-lg text-gray-900 placeholder:text-gray-400 bg-transparent border-0 dar:text-white focus:ring-0"
        ></textarea>
      </div>
    </div>
    <!-- File selector -->
    ...
    <div class="flex p-2 pl-14">
      <div
        ...
        class="cursor-pointer p-2 text-blue-400 rounded-full hover:bg-blue-50 dar:hover:bg-dim-800"
      >
